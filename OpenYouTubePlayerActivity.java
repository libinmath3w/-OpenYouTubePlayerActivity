 ...
 *
 * @author Libin Math3w
 * Special thank to original developer David Keyes
 * Now added support for android N+
 */
public class OpenYouTubePlayerActivity extends Activity {
    ...
    private void setupView() {
        ...
        RelativeLayout.LayoutParams lRelLayoutParms = new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.FILL_PARENT, ViewGroup.LayoutParams.FILL_PARENT);
        lRelLayout.setLayoutParams(lRelLayoutParms);
        lLinLayout.addView(lRelLayout);

        mVideoView = new VideoView(this);
        mVideoView.setId(3);
        RelativeLayout.LayoutParams lVidViewLayoutParams = new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.FILL_PARENT, ViewGroup.LayoutParams.FILL_PARENT);
    ...
    private class QueryYouTubeTask extends AsyncTask<YouTubeId, ProgressUpdateInfo, Uri> {
        ...
        protected Uri doInBackground(YouTubeId... pParams) {
            if (pParams[0] instanceof FIleId) {
                ...
                try {
                    ...
                    //now this support for android N and above. fixed memory leakage problem
                    WifiManager lWifiManager = (WifiManager) OpenYouTubePlayerActivity.this.getApplicationContext().getSystemService(Context.WIFI_SERVICE);
        ...
        private void showErrorAlert() {
            ...
            try {
                Builder lBuilder = new Builder(OpenYouTubePlayerActivity.this);
